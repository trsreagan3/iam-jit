...
from .manifest import (
    ...
    KEY_TRUST_EMBEDDED_UNPINNED as MANIFEST_KEY_TRUST_EMBEDDED_UNPINNED,
    KEY_TRUST_LOCAL as MANIFEST_KEY_TRUST_LOCAL,
    KEY_TRUST_PINNED as MANIFEST_KEY_TRUST_PINNED,
    MANIFEST_DIR_NAME,
